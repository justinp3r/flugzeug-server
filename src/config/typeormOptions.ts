...
import { Flugzeug } from '../flugzeug/entity/flugzeug.entity.js';
import { dbType } from './db.js';
import { entities } from '../flugzeug/entity/entities.js';
...
// nullish coalescing
const database =
    (db?.name as string | undefined) ?? Flugzeug.name.toLowerCase();

const host = (db?.host as string | undefined) ?? 'localhost';
const username =
    (db?.username as string | undefined) ?? Flugzeug.name.toLowerCase();
