...
import { type FlugzeugModel } from '../../src/flugzeug/rest/flugzeug-get.controller.js';
...
describe('GET /rest/:id', () => {
    ...
    test('Flugzeug zu vorhandener ID', async () => {
        ...
        // when
        const { status, headers, data }: AxiosResponse<FlugzeugModel> =
    ...
    test('Kein Flugzeug zu nicht-vorhandener ID', async () => {
        // given
    ...
    test('Kein Flugzeug zu falscher ID', async () => {
        // given
        const url = `/${idFalsch}`;
    ...
    test('Flugzeug zu vorhandener ID mit ETag', async () => {
        // given
