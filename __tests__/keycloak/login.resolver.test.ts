...
import { type GraphQLQuery } from '../flugzeug/flugzeug-mutation.resolver.test.js';
import { type GraphQLResponseBody } from '../flugzeug/flugzeug-query.resolver.test.js';
