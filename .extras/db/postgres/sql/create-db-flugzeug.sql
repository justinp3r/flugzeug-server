...
--        chown postgres:postgres /var/lib/postgresql/tablespace/flugzeug
...
-- (5) 2. PowerShell:
--     docker compose exec db bash
--        psql --dbname=postgres --username=postgres --file=/sql/create-db-flugzeug.sql
--        psql --dbname=flugzeug --username=flugzeug --file=/sql/create-schema-flugzeug.sql
--        exit
--      docker compose down
...
CREATE ROLE flugzeug LOGIN PASSWORD 'p';

-- https://www.postgresql.org/docs/current/sql-createdatabase.html
CREATE DATABASE flugzeug;

GRANT ALL ON DATABASE flugzeug TO flugzeug;

-- https://www.postgresql.org/docs/10/sql-createtablespace.html
CREATE TABLESPACE flugzeugspace OWNER flugzeug LOCATION '/var/lib/postgresql/tablespace/flugzeug';
