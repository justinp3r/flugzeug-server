...
."FlugzeugGetController" für Lesezugriffe an der REST-Schnittstelle
[plantuml,FlugzeugGetController,svg]
----
include::FlugzeugGetController.plantuml[]
----
...
."FlugzeugWriteController" für Schreibzugriffe an der REST-Schnittstelle
[plantuml,FlugzeugGetController,svg]
----
include::FlugzeugWriteController.plantuml[]
----
...
.FlugzeugQueryResolver für Lesezugriffe an der GraphQL-Schnittstelle
[plantuml,FlugzeugQueryResolver,svg]
----
include::FlugzeugQueryResolver.plantuml[]
----

Donec sollicitudin molestie malesuada. Praesent sapien massa, convallis a
pellentesque nec, egestas non nisi.

.FlugzeugMutationResolver für Schreibzugriffe an der GraphQL-Schnittstelle
[plantuml,FlugzeugMutationResolver,svg]
----
include::FlugzeugMutationResolver.plantuml[]
----
...
."FlugzeugReadService" von der Geschäftslogik
[plantuml,FlugzeugReadService,svg]
----
include::FlugzeugReadService.plantuml[]
----

Pellentesque in ipsum id orci porta dapibus. Donec rutrum congue leo eget
malesuada.

."FlugzeugWriteService" von der Geschäftslogik
[plantuml,FlugzeugWriteService,svg]
----
include::FlugzeugWriteService.plantuml[]
----
...
.Entity
[plantuml,Flugzeug,svg]
----
include::Flugzeug.plantuml[]
----
